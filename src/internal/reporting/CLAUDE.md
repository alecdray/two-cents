...
Pure month-wrap projection: given a month's transaction rows it derives gross income, total spending, net income, savings contributed, surplus, spend-by-Category, and the settling/final state. **Actuals only** — it never reads or compares against a Budget.
