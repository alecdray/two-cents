...
- **Account kind = cash | credit**, seeded from the provider but user-overridable; drives the overview. **Net cash = all cash balances (savings included) − all credit balances.** Investment/brokerage accounts out of scope.
